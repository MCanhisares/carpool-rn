...
export const confirmDriver = (id, position) => fetch(`${API.URL}/ride/${id}/confirm-driver`, {
    method: 'POST',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
...
export const confirmPassenger = (id, position) => fetch(`${API.URL}/ride/${id}/confirm-passenger`, {
    method: 'POST',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
